...
class ResumeApp:
    ...
    def render_dashboard(self):
        ...
        st.toast("Check out these repositories: [finger drawer] (https://github.com/Akhileshrajurs/traffic-prediction-system-)", icon="ℹ️")
    ...
    current_name.replace(
        ...
        st.toast("Check out these repositories: [traffic prediction](https://github.com/Akhileshrajurs/traffic-prediction-system-)", icon="ℹ️")
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else ''}"
                     alt="Akhilesh"
                     class="profile-image">
                <h2 class="profile-name">Akhilesh</h2>
                ...
                <p class="bio-text">
                    ...
                    I use Smart Resume AI to revolutionize how job seekers approach their career journey.
                    With a strong background in software development and AI, this platform is designed to
    ...
    "Upload your resume", type=[
        ...
        st.toast("Check out these repositories: [cyber cafe](https://github.com/Akhileshrajurs/cyber-cafe-system)", icon="ℹ️")
    ...
    def render_job_search(self):
        ...
        st.toast("Check out these repositories: [library system](https://github.com/Akhileshrajurs/library-management-system)", icon="ℹ️")
...
"""
    ...
    def main(self):
        ...
        # Check query params for admin session (persists across browser refresh)
        query_params = st.query_params
        if 'admin_session' in query_params and query_params['admin_session'] == 'active':
            if 'admin_email' in query_params:
                # Restore admin session from query params
                if not st.session_state.get('is_admin', False):
                    st.session_state.is_admin = True
                    st.session_state.current_admin_email = query_params['admin_email']
            ...
            if st.session_state.get('is_admin', False):
                ...
                if st.button("Logout", key="logout_button"):
                    try:
                        ...
                        if 'admin_email' in st.query_params:
                            del st.query_params['admin_email']
                    ...
                    if st.button("Login", key="login_button"):
                            try:
                                if verify_admin(admin_email_input, admin_password):
                                    ...
                                    # Set query params to persist session across browser refresh
                                    st.query_params['admin_session'] = 'active'
                                    st.query_params['admin_email'] = admin_email_input
